...
<html>
    ...
    <body>
        ...
        <table border="1" style="width: 100%" class="inventory">
            ...
            <tr>
                <td style=" width: 80%; text-align:left; height: 200px; vertical-align: top"><%=particular %></td>
                <td style=" width: 20%;vertical-align: top; text-align: center; height: 200px"><%=debitAmount%></td>
            </tr>
            <tr>
                <td style=" width: 80%; font-weight: bold; text-align: left">In Word:</td>
                <td style=" width: 20%; font-weight: bold; text-align: center"><%=debitAmount%></td>
            </tr>
