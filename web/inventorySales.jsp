...
<td style="width: 65%; vertical-align: top  " >
    ...
    <form name="inventorySales"  id="inventorySalesID" action="InsertInventoryServlet" method="post">
        <input id='salesOrPurchae' name='salesOrPurchae' type='hidden' value='Sales'>
        ...
        <br>
        <table id="selectTable"  style="width:100%; background: #336ca6;"  >
            <tr>
                <td style=" font-weight: bold; width:30%; text-align: left">
                    Select Customer From List                    
                </td>
                <td style="width: 70%; text-align: left">
                    <select id="customerListID" name="customerList" onchange="getInfo(this.value)" >${customerList}</select>
