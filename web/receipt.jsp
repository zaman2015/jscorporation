...
<jsp:include page="left.jsp" />
    <td style="width: 65%; vertical-align: top " >
        <div class="span">RECEIPTS</div>
        <form action="PaymentServlet" method="post">
            <input id="typeId" type="hidden" name="type" value="receipt">
            <h3 style="color: red">${successMsg}</h3>
            <span id="msg" style="color: red"></span>
            <table style="width: 100%">
                <tr>
                    <td>
                        <table style="width: 100%; text-align: left" class="salesHead">
                            <tr>
                    ...
                    <td>
                        <table style="width: 100%; text-align: left" class="purchase">
                            <tr>
