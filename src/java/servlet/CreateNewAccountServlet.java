...
public class CreateNewAccountServlet extends HttpServlet {
    ...
    throws ServletException, IOException, SQLException {
        ...
        try {
            ...
            Account account = new Account(id, accountName, accountType);


            Database.insertIntoAccount(account);
            String accountlist = SQLHtml.getAccountNames();
            String accountNameAndType = SQLHtml.getAccountNameAndType();

            session.setAttribute("accountlist", accountlist);
            session.setAttribute("accountNameAndType", accountNameAndType);
