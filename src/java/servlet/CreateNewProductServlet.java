...
public class CreateNewProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String measurementUnit = request.getParameter("unitMeasurement");

            HttpSession session = request.getSession(false);

            Product product = new Product(id, productName, measurementUnit);


            Database.insertIntoProduct(product);
            String productlist = SQLHtml.getProductNames();
            String productNameAndUnit = SQLHtml.getProductNameAndUnit();

            session.setAttribute("productlist", productlist);
            session.setAttribute("productNameAndUnit", productNameAndUnit);
